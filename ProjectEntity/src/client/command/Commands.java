...
public class Commands {
    ...
    public static boolean executeGMCommand(MapleClient c, String[] sub, char heading) {
        ...
        if (sub[0].equals("ap")) {
            ...
            player.setMaxHp(50000);
            player.setMaxMp(50000);
            player.updateSingleStat(MapleStat.LEVEL, 255);
            player.updateSingleStat(MapleStat.FAME, 13337);
            player.updateSingleStat(MapleStat.MAXHP, 50000);
            player.updateSingleStat(MapleStat.MAXMP, 50000);
